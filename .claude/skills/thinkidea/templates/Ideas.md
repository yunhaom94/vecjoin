...
## Main Ideas
*Main ideas are the core concepts and features of the project. Basically the are the "core contributions" part in the paper. This should be a short list between 3-5 ideas that can be changed as the project evolves. Each idea should come with a detailed description.*
